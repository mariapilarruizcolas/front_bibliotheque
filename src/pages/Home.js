    ...
    return (
        <div className='component2'>
            ...
            <div className="buttonsBorrowing">
                <button className="borrowing" onClick={clickToCreateBorrowing}>Emprunter un livre</button>
                <button className="borrowing" onClick={clickToReturnBook}>Rendre un livre</button>
            </div>
        </div>
    );
}
